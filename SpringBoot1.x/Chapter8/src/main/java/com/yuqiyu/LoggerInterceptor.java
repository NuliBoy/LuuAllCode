...
import com.yuqiyu.chapter8.util.ResponseWrapper;
...
public class LoggerInterceptor implements HandlerInterceptor {
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object o, Exception e) throws Exception {
        ...
        String json = doFilterInternal(response);
    ...
    protected String doFilterInternal(HttpServletResponse response) throws ServletException, IOException {
        ResponseWrapper wrapper = new ResponseWrapper(response);
        String responseStr = "";
        try {

            responseStr = new String(wrapper.getContent(), response.getCharacterEncoding());
